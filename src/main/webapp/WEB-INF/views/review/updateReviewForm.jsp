...
<script type="text/javascript" src="/resources/js/updateReviewForm.js"></script>
<link rel="stylesheet" type="text/css" href="/resources/css/updateReviewForm.css">
...
<form action="/review/updateReview" id="updateReview" enctype="multipart/form-data" method=POST>
	<div id="tableWrapper">
		<div id="tableDiv"> 
				...
				<tr>
					...
					<td>
						<div class="input-group mb-3">	
  							<input type="text" class="form-control" name="review_title" id="review_title" placeholder="" aria-label="review_title" aria-describedby="basic-addon1" value="${review.review_title}">
  							<input type="hidden" value="${review.review_num}" name = "review_num" id = "review_num">
  						</div>
					</td>
				</tr>
				<tr>
					...
					<td id="contentTd">
						<div class="form-floating">
  							<textarea class="form-control" name = "review_text"  id="review_text">${review.review_text}</textarea>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td id="fileTd">
						<div class="form-floating">
  							...
  							<span>${review.review_originalfile}</span>
						</div>
					</td>
				</tr>
			</table>
...
<div id="buttonDiv">
	<input type="button" id="updateButton" class="btn btn-secondary btn-lg" value="리뷰 수정" onclick="updateReviewCheck();">
</div>
